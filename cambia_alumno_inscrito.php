        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" name="frmEnviaAltaGrupo" method="POST" action="actualiza_alumno_inscrito.php" >
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="hidden" class="form-control" name="idGrupoIns" value="<?php echo $ID; ?>" >
