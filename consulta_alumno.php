                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="form-group form-float">
		                        <div class="form-line">
		                            <input type="text" class="form-control" name="numeroCuenta" maxlength="10" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required disabled value="<?php echo $numeroCuenta; ?>">
		                            <label class="form-label">Número de Cuenta del Alumno:</label>
		                        </div>
		                    </div>
		                    <div class="form-group form-float">
		                        <div class="form-line">
		                            <input type="text" class="form-control" name="nombreAlumno" required disabled value="<?php echo $nombreAlumno; ?>">
		                            <label class="form-label">Nombre del Alumno:</label>
		                        </div>
		                    </div>
		                    <div class="form-group form-float">
		                        <div class="form-line">
		                            <input type="text" class="form-control" name="appAlumno" required disabled value="<?php echo $appAlumno; ?>">
		                            <label class="form-label">Apellido Paterno del Alumno:</label>
		                        </div>
		                    </div>
		                    <div class="form-group form-float">
		                        <div class="form-line">
		                            <input type="text" class="form-control" name="apmAlumno" required disabled value="<?php echo $apmAlumno; ?>">
		                            <label class="form-label">Apellido Materno del Alumno:</label>
		                        </div>
		                    </div>
		                    <div class="form-group form-float">
		                        <div class="form-line">
		                            <input type="text" class="form-control" name="correoAlumno" required disabled value="<?php echo $correoAlumno; ?>">
